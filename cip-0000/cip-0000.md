...
During discussions, and before proposing the CIP for a vote, the proposal should be submitted to the [cips git repository](https://github.com/canton-foundation/cips) as a pull request.
...
If the Author has not yet created a pull request the Editor will create a one in the [cips git repository](https://github.com/canton-foundation/cips), where it may get further feedback.

The CIP author may update the draft as necessary in the [cips git repository](https://github.com/canton-foundation/cips). Updates to drafts should also be submitted by the Author or Editor as pull requests.
