...
`splice.lfdecentralizedtrust.org/`. Concretely, this CIP introduces the following four
...
- `splice.lfdecentralizedtrust.org/reason`: used to communicate a human-readable
  ...
  instruction).
- `splice.lfdecentralizedtrust.org/logoURL`: This field provides the public URL 
