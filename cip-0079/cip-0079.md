...
|-------------|---------------------|----------|
| **R1 - Ingest a reference price feed** | Subscribe to one feed delivering CC/USD to the SV | Must be live on MainNet by 2025-10-15 |
| **R2 - Publish on-chain** | Update your on-chain conversion rate as the reference rate changes | Must be live on MainNet by  2025-10-15 |
