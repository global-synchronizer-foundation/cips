...
* If any milestones and associated rewards are not achieved by the deadline
    ...
    * Remaining SV Weight on the `extraBeneficiary` SV will be removed from the SV Operator configs, and the total SV weight of the GSF SV node will be reduced by the same amount. 
