...
* If any milestones and associated rewards are not achieved by the deadline
    ...
    * Remaining SV Weight assigned to the `extraBeneficiary` SV will be removed from the GSF node, and the total SV weight of the GSF SV node will be reduced by the same amount by a vote of the Super Validators.
