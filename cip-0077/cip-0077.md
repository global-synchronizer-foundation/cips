...
* Notes on the Adoption Bonus: In addition, to better align incentives with long-term ecosystem participation and retention rather than short-term issuance activity only, we propose linking the retained bonus weight to sustained TVL and ecosystem engagement. Under this approach:
